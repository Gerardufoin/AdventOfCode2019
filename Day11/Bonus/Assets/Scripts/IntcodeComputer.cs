...
namespace Day11
{
    ...
    class IntcodeComputer
    {
        ...
        // Set if an error occurs in the computer
        ...
        /// <summary>
        /// Woops. The computer crashed. A shame, really.
        /// </summary>
        ...
        private void Process()
        {
            ...
            do
            {
                ...
                {
                    Crash("'" + code + "' is not a valid instruction.");
                    return;
                }
        ...
        private BigInteger Read(BigInteger idx)
        {
            if (idx < 0)
            {
                Crash("Tried to access memory at a negative address.");
                return 0;
            }
        ...
        private BigInteger GetValue(int mode, BigInteger idx, bool write = false)
        {
            ...
            {
                Crash("'" + mode + "' is not a supported mode.");
                return 0;
            }
