...
namespace Day17
{
    ...
    class IntcodeComputer
    {
        ...
        /// <summary>
        /// Edit the opcode memory of the computer from outside.
        /// </summary>
        /// <param name="idx">Index of the value to edit</param>
        /// <param name="val">Value to edit</param>
        public void EditMemory(BigInteger idx, BigInteger val)
        {
            ...
            {
                _opcodes.Add(idx, val);
            }
            if (_baseOpcodes.ContainsKey(idx))
            {
                _baseOpcodes[idx] = val;
            }
            else
            {
                _baseOpcodes.Add(idx, val);
            }
        }
